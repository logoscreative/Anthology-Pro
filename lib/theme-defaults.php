...
add_filter( 'genesis_theme_settings_defaults', 'anthology_pro_theme_defaults' );
/**
* Updates theme settings on reset.
*
* @since 2.2.3
*/
function anthology_pro_theme_defaults( $defaults ) {
...
add_action( 'after_switch_theme', 'anthology_pro_theme_setting_defaults' );
/**
* Updates theme settings on activation.
*
* @since 2.2.3
*/
function anthology_pro_theme_setting_defaults() {
